...
# load data
engine = create_engine('sqlite:///../data//DisasterResponse.db').connect()
...
# index webpage displays homepage
@app.route('/')
def master_web():
    # This will render the master_web.html 
    return render_template('master_web.html')

@app.route('/extra/')
def extra():
    # This will render the extra.html 
       ...
       
        {
            'data': [
                Bar(
                    ...
                    y=category_boolean,
                    #orientation = 'h',
                    marker=dict(color="lavenderblush")
